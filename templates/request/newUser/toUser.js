                              ...
                              <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                ...
                                <tr>
                                  <td class="td-padding" align="left" style="font-family: 'Trebuchet MS', monospace; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                    Your request is pending for confirmation. You will receive an email containing your One Time Password(OTP) to activate your account. Please activate your account within 48 Hours after you recieve confirmation email. Otherwise your account will be deleted automatically. Please join our telegram group for help.
                                    <br><br>
                                    Have a nice day ! 
                                    <br><br>
                                    Regards from,
